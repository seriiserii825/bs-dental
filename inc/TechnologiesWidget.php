...
// Класс виджета
class TechnologiesWidget extends WP_Widget {
	...
	function widget($args, $instance ) {
        ...
        $technologies_posts = new WP_Query([
            'posts_per_page' => -1,
        ...
        if($technologies_posts->have_posts()){
            while($technologies_posts->have_posts()){
               $technologies_posts->the_post();
...
add_action( 'widgets_init', 'register_technologies_widget' );
function register_technologies_widget() {
	register_widget( 'TechnologiesWidget' );
}
