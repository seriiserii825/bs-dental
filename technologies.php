...
<div class="intro intro-small">
    ...
    <div class="row">
        <div class="intro-caption">
            <h5><?php echo carbon_get_theme_option('crb_technologies_page_title'.get_lang()); ?></h5>

            <h2><?php echo carbon_get_theme_option('crb_technologies_page_subtitle'.get_lang()); ?></h2>
        </div><!-- /.intro-caption -->
    </div><!-- /.row -->
                        ...
                        <div class="service">
                            <div class="service-box">
                                ...
                                <div class="service-body">
                                    ...
                                    <p itemprop='description'><?php echo carbon_get_the_post_meta('crb_services_technologies_short_text' . get_lang()); ?></p>
